...
const UserProfile = props => {
  ...
  const [colorBackground, setColorBackground] = useState(props.user.backgroundColor ? props.user.backgroundColor: `#000`)
  const [openChangeColorModal, setOpenChangeColorModal] = useState(false)
  const handleColorChange = ({ hex }) => {
    props.socket.emit("change-backgroundColor", {colorBackground, token: window.localStorage.getItem("token")})
    setColorBackground(hex)
  }
  ...
  const onChangeFileCover = (event) => {
    ...
    var reader = new FileReader();
        reader.readAsDataURL(file);
        reader.onload = function () {
          var backgroundImage = reader.result;
          props.socket.emit("change-backgroundImage", {backgroundImage, token: window.localStorage.getItem("token")})
        }
  }
  return (
    <>
    ...
    type='file' id='file' ref={inputFile} style={{display: 'none'}}/>
     <input 
    onChange={onChangeFileCover.bind(this)}
    type='file' id='file' ref={inputFileCover} style={{display: 'none'}}/>
                    ...
                    <div className="baseLayout-8AMrwn">
                      <div>
                        ...
                        <div className="customizationSection-IGy2fS profileColorSection-2BQBEp">
                          ...
                          <div className="buttonsContainer-3rygH4" aria-label="Cor do perfil" role="radiogroup" aria-orientation="horizontal" aria-disabled="false">
                            <div className="colorSwatch-3KbHGH">
                              <div 
                              className role="radio" tabIndex={-1} aria-label="Usar cor de perfil personalizada. Selecionada: #36393f" aria-checked="false">
                                
                                <div className="customSwatch-I4jK4z swatch-35F5kl defaultSwatch-1tVtRe" style={{backgroundColor: colorBackground}}>
                              ...
                              <div 
                              onClick={() => {
                                setOpenChangeColorModal(!openChangeColorModal)
                              }}
                              className="dropperIconButton-15Dl5X" aria-controls="popout_55" aria-expanded="false" aria-label="Selecionar cor personalizada" role="button" tabIndex={0}>
                        ...
                        <div className="customizationSection-IGy2fS">
                          ...
                          type="button" className="shinyButton-2Q9MDB button-f2h6uQ lookFilled-yCfaCM colorGreen-3y-Z79 sizeMedium-2bFIHr grow-2sR_-F">
                            <div className="contents-3ca1mk nitroUpsellButtonInner-KVmxak">
                              Alterar imagem de fundo <div className="shineContainerDefault-3f8X_o shineContainer-NmlfaV buttonShine-p5V5TB">
                      ...
                      <div className="customizationSection-IGy2fS preview-Z55SA3">
                        ...
                        <div 
                        className="profileBannerPreview-3mLIdO">
                          <div 
                          onClick={() => {
                            inputFileCover.current.click();
                          }}
                          className="bannerNormal-2jf-df banner-3D8GgT" style={{backgroundColor: colorBackground}}>
                            { props.user.coverPhoto && <img 
                            style={{
                              width: `100%`,
                              objectFit: `cover`,
                              height: `100%`
                            ...
                            <div className="bannerNitroUpsell-2iP18z" role="button" tabIndex={0}>
                              <h3 className="bannerNitroUpsellText-Ll6vKY base-21yXnu size12-oc4dx4 uppercase-2unHJn">Alterar imagem</h3>
                            </div>
                          </div>
                          <div 
                          ...
                          className="imageUploader-1X7wVc avatarUploaderNormal-2m2hFm avatarUploader-qEFQS2">
                            ...
                            style={{backgroundImage: `url("${ typeof props.user.photo != `object` ? props.user.photo : window[`getPath`]() + `assets/default.webp`}")`}}>
                              ...
                              className="fileInput-1LZSb9" aria-label="Mudar
