const PopOutProfile = props => {
    ...
    <div className="headerNormal-3Zn_yu">
      <div className="banner-1YaD3N popoutBanner-3cqRD9" style={{backgroundColor: 'rgb(252, 164, 28)'}}>
    ...
    <div className="avatarWrapperNormal-ahVUaC avatarWrapper-eenWra avatarPositionNormal-2jWoC2 clickable-GKg4Qy" role="button" tabIndex={0}>
      <div className="avatarHoverTarget-1zzfRL">
        <div className="avatar-2Vndt_ wrapper-1VLyxH" role="img" aria-hidden="false" style={{width: '80px', height: '80px'}}>
          <svg width={92} height={80} viewBox="0 0 92 80" className="mask-1FEkla svg-2azL_l" aria-hidden="true">
            <foreignObject x={0} y={0} width={80} height={80} mask="url(#svg-mask-avatar-status-round-80)">
              <div className="avatarStack-3vfSFa">
                <img src={`${ typeof props.user.user.photo != `object` ? props.user.user.photo : window[`getPath`]() + `assets/default.webp`}`} alt=" " className="avatar-b5OQ1N" aria-hidden="true" />
              </div>
            </foreignObject>
      ...
      <svg width={80} height={80} className="avatarHint-k7pYop" viewBox="0 0 80 80">
