      ...
      <div className="scroller-3X7KbA none-2-_0dP scrollerBase-_bVAAt" dir="ltr" style={{overflow: 'hidden scroll', paddingRight: '0px'}}>
            ...
            <div className="listItemWrapper-3d87LP selected-3a1QGn">
              <div className="wrapper-28eC3z">
                <svg width={48} height={48} viewBox="0 0 48 48" className="svg-2zuE5p" overflow="visible">
                  <defs>
                    <path d="M0 24C0 16.5449 0 12.8174 1.21793 9.87706C2.84183 5.95662 5.95662 2.84183 9.87706 1.21793C12.8174 0 16.5449 0 24 0C31.4551 0 35.1826 0 38.1229 1.21793C42.0434 2.84183 45.1582 5.95662 46.7821 9.87706C48 12.8174 48 16.5449 48 24C48 31.4551 48 35.1826 46.7821 38.1229C45.1582 42.0434 42.0434 45.1582 38.1229 46.7821C35.1826 48 31.4551 48 24 48C16.5449 48 12.8174 48 9.87706 46.7821C5.95662 45.1582 2.84183 42.0434 1.21793 38.1229C0 35.1826 0 31.4551 0 24Z" id="0c23ccc1-cd5d-4e6f-aba8-4bcd00d6dfa4-blob_mask" />
                  </defs>
                  <mask id="0c23ccc1-cd5d-4e6f-aba8-4bcd00d6dfa4" fill="black" x={0} y={0} width={48} height={48}>
                    <use href="#0c23ccc1-cd5d-4e6f-aba8-4bcd00d6dfa4-blob_mask" fill="white" />
                  </mask>
                  <foreignObject mask="url(#0c23ccc1-cd5d-4e6f-aba8-4bcd00d6dfa4)" x={0} y={0} width={48} height={48}>
                ...
                { props.myFriends.filter(friend => friend.statusAmizade === 'pending' && friend.createdBy != props.user.id).length > 0 &&
                ...
                borderRadius: '50%', transform: 'scale(1) translate(30px, 25px)'}}>
        ...
        <div aria-label="Servidores">
          <div className="listItem-3SmSlK">
            ...
            <div>
              <div data-dnd-name="🥋TROPA DO CAIXETA🥋" className="blobContainer-ikKyFs" draggable="true">
                <div className="wrapper-28eC3z">
                  <svg width={48} height={48} viewBox="0 0 48 48" className="svg-2zuE5p" overflow="visible">
                    <defs>
                      <path d="M48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24Z" id="3eaec676-3951-437c-968a-5a885ae2de73-blob_mask" />
                    </defs>
                    <mask id="3eaec676-3951-437c-968a-5a885ae2de73" fill="black" x={0} y={0} width={48} height={48}>
                      <use href="#3eaec676-3951-437c-968a-5a885ae2de73-blob_mask" fill="white" />
                    </mask>
                    <foreignObject mask="url(#3eaec676-3951-437c-968a-5a885ae2de73)" x={0} y={0} width={48} height={48}>
                      <div className="wrapper-3kah-n" role="treeitem" data-list-item-id="guildsnav___691063304109555732" tabIndex={-1} aria-label=" 🥋TROPA DO CAIXETA🥋">
                        <img className="icon-3AqZ2e" src="https://cdn.discordapp.com/icons/691063304109555732/a_4300228d0d9f082e2b41f4e790427c39.webp?size=96" alt=" " width={48} height={48} aria-hidden="true" />
                      </div>
                    </foreignObject>
                  </svg>
                </div>
            ...
            <div className="wrapper-3XVBev" aria-hidden="true">
              <div data-dnd-name="Acima 🥋TROPA DO CAIXETA🥋" className="target-1eRTCg" />
          ...
          <div className="listItem-3SmSlK">
            <div className="listItemWrapper-3d87LP">
              <div className="wrapper-28eC3z">
                <svg width={48} height={48} viewBox="0 0 48 48" className="svg-2zuE5p" overflow="visible">
                  <defs>
                    <path d="M48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24Z" id="43270225-2986-43de-9298-7c8a90774670-blob_mask" />
                  </defs>
                  <mask id="43270225-2986-43de-9298-7c8a90774670" fill="black" x={0} y={0} width={48} height={48}>
