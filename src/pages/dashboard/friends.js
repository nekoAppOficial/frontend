    ...
    <div className="base-2jDfDU">
      ...
      >
            ...
            >
              <div
                ...
                className={`item-3mHhwr item-3XjbnG themed-2-lozF ${
                  tab == `myFriends` && typeFriend == `accept`
                    ? "selected-g-kMVV"
                    : ``
                }`}
                role="tab"
              ...
              <div
                ...
                className={`item-3mHhwr item-3XjbnG themed-2-lozF ${
                  tab == `myFriends` && typeFriend == `pending`
                    ? "selected-g-kMVV"
                    : ``
                }`}
                role="tab"
              ...
              <div
                ...
                className={`item-3mHhwr item-3XjbnG themed-2-lozF ${
                  tab == `add` ? "selectAdds" : `notSelectAdds`
                }`}
                role="tab"
                aria-selected="false"
          ...
          <div className="toolbar-3_r2xA">
            <div
              ...
              onMouseOver={() => {
                props.toolTipShow(
                  `Novo grupo privado`,
                  novoGrupoPrivado.current.offsetLeft + 265,
                  novoGrupoPrivado.current.offsetTop + 35
                );
              }}
              onMouseLeave={() => {
                props.toolTipHide();
        ...
        <div className="tabBody-2dgbAs">
          {tab == `add` && <AddFriendTab me={props.me} socket={props.socket} />}
          {tab == `myFriends` && (
            <MyFriends
